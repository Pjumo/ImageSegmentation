...
def _segm_resnet(name, backbone_name, num_classes, output_stride, pretrained_backbone):
    ...
    if backbone_name == 'resnet50':
        ...
        backbone = resnet50(weights=weights, replace_stride_with_dilation=replace_stride_with_dilation)
    elif backbone_name == 'resnet101':
        weights = ResNet101_Weights.DEFAULT if pretrained_backbone else None
        backbone = resnet101(weights=weights, replace_stride_with_dilation=replace_stride_with_dilation)
    else:
